 ...
 *  
 */
package com.ecenta.hproject.cockpits.setup;
...
import com.ecenta.hproject.cockpits.constants.HprojectCockpitsConstants;
 ...
 */
@SystemSetup(extension = HprojectCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(HprojectCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(HprojectCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						HprojectCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/hprojectcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
