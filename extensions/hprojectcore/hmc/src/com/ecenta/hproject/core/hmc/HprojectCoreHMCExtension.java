 ...
 *  
 */
package com.ecenta.hproject.core.hmc;
...
/**
 * Provides necessary meta information about the hprojectcore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class HprojectCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(HprojectCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.ecenta.hproject.core.hmc.locales";
