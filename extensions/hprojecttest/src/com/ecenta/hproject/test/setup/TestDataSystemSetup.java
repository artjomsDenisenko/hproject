 ...
 *  
 */
package com.ecenta.hproject.test.setup;
...
import com.ecenta.hproject.test.constants.HprojectTestConstants;
import com.ecenta.hproject.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = HprojectTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/hprojecttest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/hprojecttest/import/reviews.impex");
			...
			importImpexFile(context, "/hprojecttest/import/cstickets.impex");
		}
	}
}
