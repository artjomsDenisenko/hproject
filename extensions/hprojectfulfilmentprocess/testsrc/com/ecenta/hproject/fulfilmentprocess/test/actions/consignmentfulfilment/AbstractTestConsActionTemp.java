 ...
 *  
 */
package com.ecenta.hproject.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, HprojectFulfilmentProcessConstants.PARENT_PROCESS);
