 ...
 *  
 */
package com.ecenta.hproject.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(HprojectFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(HprojectFulfilmentProcessConstants.PARENT_PROCESS);
