...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/hprojectstorefront/electronics/en",
						"https://electronics.local:9002/hprojectstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/hprojectstorefront/electronics/en",
						"https://electronics.local:9002/hprojectstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/hprojectstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/hprojectstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/hprojectstorefront/electronics/en",
						"https://electronics.local:9002/hprojectstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/hprojectstorefront",
						"https://electronics.local:9002/hprojectstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/hprojectstorefront",
						"https://electronics.local:9002/hprojectstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/hprojectstorefront/electronics/en",
						"https://electronics.local:9002/hprojectstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
